        ...
        <div class="container">
            ...
            <p>
                <form action="../controller/controller.php">
                    ...
                    Codigo del producto:<input type="text" name="idProducto" maxlength="50" required="true">
                    Nombre del producto:<input type="text" name="nombre" maxlength="50" required="true">
